...
(function () {
  ...
  /* ---------------------------------------------------------------------
     Scrollspy — highlights whichever section's nav link matches what's
     currently centered in the viewport. Quiet, but it's the kind of
     detail that makes a single-page site feel like it knows where you are.
     --------------------------------------------------------------------- */
  ...
  if (navLinks.length && 'IntersectionObserver' in window) {
    ...
    navLinks.forEach(function (link) {
      ...
      if (section) linkBySection[id] = link;
    });
    ...
    var spy = new IntersectionObserver(
      function (entries) {
        entries.forEach(function (entry) {
          ...
          var activeLink = linkBySection[entry.target.id];
